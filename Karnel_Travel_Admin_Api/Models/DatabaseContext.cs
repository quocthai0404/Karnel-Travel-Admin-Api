...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-6L06R65;Database=Karnel_Travel;user id=sa;password=123456;trusted_connection=true;encrypt=false");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__active_a__3213E83FE53E1F89");

            entity.ToTable("active_account");

            entity.HasIndex(e => e.Email, "UQ__active_a__AB6E6164D1F18C15").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__admin_ac__3213E83FE687D2AE");
        ...
        {
            entity.HasKey(e => e.AirportId).HasName("PK__airport__C795D516E0DAD79F");
        ...
        {
            entity.HasKey(e => e.BeachId).HasName("PK__beach__7DED2FB06272D172");
        ...
        {
            entity.HasKey(e => e.BookingId).HasName("PK__booking__5DE3A5B18CA9DA48");
        ...
        modelBuilder.Entity<Discount>(entity =>
        {
            ...
            entity.HasIndex(e => e.DiscountCode, "UQ__discount__75C1F0064CFFDE86").IsUnique();
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__district__2521322B2C103E72");
        ...
        {
            entity.HasKey(e => e.FacilityId).HasName("PK__facility__B2E8EAAEFF867E0B");
        ...
        {
            entity.HasKey(e => e.FlightId).HasName("PK__flight__E370576555D6A58B");
        ...
        {
            entity.HasKey(e => e.FlightInvoiceId).HasName("PK__flight_i__54F1175FD9041CED");

            entity.ToTable("flight_invoice");

            entity.HasIndex(e => e.BookingId, "UQ__flight_i__5DE3A5B04428C273").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__forget_p__3213E83F6AB3B047");
        ...
        {
            entity.HasKey(e => e.HotelId).HasName("PK__hotel__45FE7E264FCD851A");
            ...
            entity.HasMany(d => d.Facilities).WithMany(p => p.Hotels)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("HotelId", "FacilityId").HasName("PK__hotel_fa__BED0F08C23503E72");
        ...
        {
            entity.HasKey(e => e.HotelInvoiceId).HasName("PK__hotel_in__53B4F48C682E6A03");

            entity.ToTable("hotel_invoice");

            entity.HasIndex(e => e.BookingId, "UQ__hotel_in__5DE3A5B0D7656E3D").IsUnique();
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EA97FEC305");
        ...
        {
            entity.HasKey(e => e.PhotoId).HasName("PK__photo__CB48C83D735B7990");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__province__08DCB60F6F76C0A1");
        ...
        {
            entity.HasKey(e => e.RestaurantId).HasName("PK__restaura__3B0FAA9157862807");
        ...
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__review__60883D90847CB104");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__room__19675A8A479EF598");
        ...
        {
            entity.HasKey(e => e.SiteId).HasName("PK__site__B22FDBCA8BED8B18");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__site_typ__2C000598923B954E");
        ...
        {
            entity.HasKey(e => e.StreetId).HasName("PK__street__665BB66B13FC5E1B");
        ...
        {
            entity.HasKey(e => e.TourId).HasName("PK__tour__4B16B9E60A2215BB");
        ...
        {
            entity.HasKey(e => e.TourInvoiceId).HasName("PK__tour_inv__CDD7DA854AA17E78");

            entity.ToTable("tour_invoice");

            entity.HasIndex(e => e.BookingId, "UQ__tour_inv__5DE3A5B0226FAE16").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370FE95B8B13");

            entity.ToTable("user");

            entity.HasIndex(e => e.Email, "UQ__user__AB6E6164C705736C").IsUnique();
        ...
        {
            entity.HasKey(e => e.WardId).HasName("PK__ward__396B899DF9CB0812");
